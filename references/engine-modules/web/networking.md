# web networking Module

Use this reference when a Codex Game Studio task needs networking decisions for a web game.
...
- Prefer browser input, DOM or canvas layout, local storage or backend contracts, bundler output, and browser profiling.
