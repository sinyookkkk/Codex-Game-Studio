# unity performance Module

Use this reference when a Codex Game Studio task needs performance decisions for a unity game.
...
- Prefer scenes, prefabs, ScriptableObjects, packages, build profiles, and profiler captures.
